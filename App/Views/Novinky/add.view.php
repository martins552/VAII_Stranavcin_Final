    ...
    <form>
        <div class="d-grid gap-2">
            <div class="form-floating">
                <input type="text" class="form-control" name="nazov" placeholder="" value="">
                <label for="floatingInput">Názov príspevku</label>
            </div>
            <div class="form-floating">
                <input type="text" class="form-control" name="miesto" placeholder="" value="">
                <label for="floatingPassword">Miesto konania</label>
            </div>
            <div class="form-floating">
                <input type="date" class="form-control" name="datum" placeholder="" value="">
                <label for="floatingPassword">Dátum konania</label>
            </div>
            <div class="form-floating">
                <input type="file" class="form-control" name="obrazok" placeholder="" value="">
